...
public abstract class Solution0011Tests<TSolution>
	: BaseSolutionTests<TSolution> where TSolution : Solution0011
{
	public Solution0011Tests(BaseSolutionFixture fixture) : base(fixture) { }
