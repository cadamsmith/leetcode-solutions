...
public abstract class Solution0001Tests<TSolution> : BaseSolutionTests<TSolution>
    where TSolution : Solution0001
{
    public Solution0001Tests(BaseSolutionFixture fixture)
        : base(fixture) { }
